        ...
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          ...
          <div className=" text-[0.92rem] text-base mx-12 font-light dark:text-white text-gray-900">
            <p className="mt-6 mb-12 font-normal">
              ...
              Experience in React.js, Node.js, Next.js, Angular and state management like
              Redux.js with proficiency in web technologies like JavaScript,
              Typescript, Tailwind CSS and SASS. 
              Also have Experience on backend like, Express js, Nest js, AWS, serverless and Firebase.
              building large-scale web applications, cross-browser platforms, and design constraints on
            ...
            <p className="">
              ...
              <a
                onClick={() =>
                  navigator.clipboard.writeText("kishordabi1111@gmail.com")
                }
                ...
                href="mailto:kishoredabi1111@gmail.com"
              >
                {" "}
                kishoredabi1111@gmail.com
              </a>{" "}
