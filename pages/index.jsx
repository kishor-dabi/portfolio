...
export default function Home() {
  ...
  useEffect(() => {
    ...
    console.log.apply(console, [
      "%c Designed and Developed by Kishore  %c %c🚀 %c\n",
        ...
        <div className="lg:h-screen 2xl:h-max max-w-[90rem] mx-auto">
          ...
          <div className="mt-12 text-base md:text-xl lg:text-xl xl:text-xl 2xl:text-xl">
            <p className="sm:leading-6 md:leading-6 lg:leading-8">
              A wizard who loves codeing. I develop modern, reactive,
              ...
              efficient, and robust design of the user interface and Backend Design and development.
            </p>
          </div>
        </div>
